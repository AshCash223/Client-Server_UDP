    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                DatagramPacket response = new DatagramPacket(buffer, buffer.length); // datagram packet for recieved
                System.out.println("Sent request, waiting for response"); //msg to indicate request has been sent
                cs.receive(response);

                byte[] recievedPacket = new byte[514]; // recievedPacket byte array to extract and
                ...
                if (expectedBN == blocknumber) {
                    ...
                    System.out.println("data packet transfered: " + recievedPacket);
